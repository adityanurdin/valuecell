...
// Trading symbols for strategy UI (Binance USDT-M perpetual format: BASE/USDT).
// Pairs must exist on the selected exchange; use MultiSelect "creatable" for others.
export const TRADING_SYMBOLS: string[] = [
  ...
  "XRP/USDT",
  "DOGE/USDT",
  // Alts (must exist on Binance USDT-M perpetuals — not spot-only)
  "LTC/USDT",
  "STORJ/USDT",
  "ADA/USDT",
  "AVAX/USDT",
